...
let CmsProfile = class CmsProfile extends lit__WEBPACK_IMPORTED_MODULE_0__.LitElement {
    createRenderRoot() {
        return this;
    }
    ClearScr() {
    ...
    constructor() {
        ...
        this.Model = {
            data: {
                pk_user: knockout__WEBPACK_IMPORTED_MODULE_3__.observable(),
                username: knockout__WEBPACK_IMPORTED_MODULE_3__.observable(),
                firstname: knockout__WEBPACK_IMPORTED_MODULE_3__.observable(),
                lastname: knockout__WEBPACK_IMPORTED_MODULE_3__.observable(),
                mobile: knockout__WEBPACK_IMPORTED_MODULE_3__.observable(),
                email: knockout__WEBPACK_IMPORTED_MODULE_3__.observable(),
                password: knockout__WEBPACK_IMPORTED_MODULE_3__.observable(),
                passwordConfirm: knockout__WEBPACK_IMPORTED_MODULE_3__.observable(),
            },
            translate: {
                tab_title_editprofile: knockout__WEBPACK_IMPORTED_MODULE_3__.observable(),
                tab_title_resetpassword: knockout__WEBPACK_IMPORTED_MODULE_3__.observable(),
                label_username: knockout__WEBPACK_IMPORTED_MODULE_3__.observable(),
                label_firstname: knockout__WEBPACK_IMPORTED_MODULE_3__.observable(),
                label_lastname: knockout__WEBPACK_IMPORTED_MODULE_3__.observable(),
                label_mobile: knockout__WEBPACK_IMPORTED_MODULE_3__.observable(),
                label_email: knockout__WEBPACK_IMPORTED_MODULE_3__.observable(),
                label_currentpassword: knockout__WEBPACK_IMPORTED_MODULE_3__.observable(),
                label_password: knockout__WEBPACK_IMPORTED_MODULE_3__.observable(),
                label_password_confirm: knockout__WEBPACK_IMPORTED_MODULE_3__.observable(),
                btn_submit: knockout__WEBPACK_IMPORTED_MODULE_3__.observable(),
                btn_edit: knockout__WEBPACK_IMPORTED_MODULE_3__.observable(),
            },
            errors: {
                username: knockout__WEBPACK_IMPORTED_MODULE_3__.observable(""),
                firstname: knockout__WEBPACK_IMPORTED_MODULE_3__.observable(""),
            ...
            setErrors: (errors) => {
                ...
                this.Model.errors.passwordConfirm(errors ? (0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.getTranslate)(errors.passwordConfirm) : undefined);
                this.Model.errors.firstname(errors ? (0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.getTranslate)(errors.firstname) : undefined);
                this.Model.errors.lastname(errors ? (0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.getTranslate)(errors.lastname) : undefined);
                this.Model.errors.mobile(errors ? (0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.getTranslate)(errors.mobile) : undefined);
                this.Model.errors.email(errors ? (0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.getTranslate)(errors.email) : undefined);
            }
        };
        this.lcid = (0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.getLanguage)();
        document.title = (0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.getTranslate)('menu_profile');
        this.Model.translate.tab_title_editprofile((0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.getTranslate)('tab_title_editprofile'));
        this.Model.translate.tab_title_resetpassword((0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.getTranslate)('tab_title_resetpassword'));
        this.Model.translate.label_username((0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.getTranslate)('label_username'));
        this.Model.translate.label_firstname((0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.getTranslate)('label_firstname'));
        this.Model.translate.label_lastname((0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.getTranslate)('label_lastname'));
        this.Model.translate.label_mobile((0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.getTranslate)('label_mobile'));
        this.Model.translate.label_email((0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.getTranslate)('label_email'));
        this.Model.translate.label_currentpassword((0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.getTranslate)('label_currentpassword'));
        this.Model.translate.label_password((0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.getTranslate)('label_password'));
        this.Model.translate.label_password_confirm((0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.getTranslate)('label_password_confirm'));
        this.Model.translate.btn_edit((0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.getTranslate)('btn_edit'));
        this.Model.translate.btn_submit((0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.getTranslate)('btn_submit'));
    }
    firstUpdated(changedProperties) {
        knockout__WEBPACK_IMPORTED_MODULE_3__.applyBindings(this.Model, document.getElementById("pnlProfile"));
        $(() => {
        });
...
CmsProfile = __decorate([
    (0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_1__.customElement)('cms-profile')
], CmsProfile);
...
/******/ var __webpack_exports__ = (__webpack_exec__("./site/page/profile.ts"));
/******/ }
]);
//# sourceMappingURL=profile.bundle.a04d59ac07e2c697ab83.js.map